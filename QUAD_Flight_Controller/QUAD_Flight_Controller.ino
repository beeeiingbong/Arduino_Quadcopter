...
float pid_i_gain_roll = 0.04;              //Gain setting for the roll I-controller(.04)
...
void loop(){
 ...
 // angle_pitch_acc -= 0.0;                                                   //Accelerometer calibration value for pitch.
  ...
  if (start == 2){                                                          //The motors are started.
    ...
    esc_4 = throttle - pid_output_pitch - pid_output_roll + pid_output_yaw; //Calculate the pulse for esc 4 (front-left - CW)//+15 chilo delete mara hye6e for I controller
